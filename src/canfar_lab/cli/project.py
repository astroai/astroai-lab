...
from canfar_lab.core.team import init_team_project, project_layout, project_quota_line
...
def project_init(
    ...
    Examples:
        canfar-lab project init mygroup
    ...
    ui.print_hint("  canfar-lab data stage /arc/projects/.../data/...")
    ui.print_hint("  canfar-lab save mylab --to /arc/projects/.../env-saves/mylab")
